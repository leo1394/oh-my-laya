...
def preferences(policy=None, path=None):
    ...
    if policy is not None:
        ...
        with tempfile.NamedTemporaryFile(
            ...
            json.dump({"policy": policy}, stream)
            stream.write("\n")
        try:
    ...
    return {
        ...
        "needs_policy_selection": policy is None,
...
def build_advice(result, models, current_model, settings):
    ...
    ask = (settings["needs_policy_selection"] or policy == "always"
    ...
    return {
        ...
        "models": models,
        "policy": policy,
        "needs_policy_selection": settings["needs_policy_selection"],
        "ask_user": ask,
